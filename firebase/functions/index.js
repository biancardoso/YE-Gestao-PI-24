...
function getDocIdBound(index, numBatches) {
  ...
  return "cadastro_usuarios/" + firstChar + secondChar;
}
...
exports.onUserDeleted = functions.auth.user().onDelete(async (user) => {
  ...
  let userRef = firestore.doc("cadastro_usuarios/" + user.uid);
  await firestore.collection("cadastro_usuarios").doc(user.uid).delete();
});
