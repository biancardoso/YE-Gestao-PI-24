            ...
            Align(
              ...
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await EditarPerfilRecord.collection
                        .doc()
                        .set(createEditarPerfilRecordData(
                          nome: _model.yourNameTextController.text,
                          estado: _model.stateValue,
                          idade: int.tryParse(_model.ageTextController.text),
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: const Text('Mudanças salvas!'),
                          content: const Text('Suas mudanças foram salvas'),
                          actions: [
                            TextButton(
                              onPressed: () =>
