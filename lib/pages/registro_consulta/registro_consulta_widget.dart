              ...
              Padding(
                ...
                child: StreamBuilder<List<ConsultasRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ConsultasRecord> listaConsultaConsultasRecordList =
                        snapshot.data!;
                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listaConsultaConsultasRecordList.length,
                      itemBuilder: (context, listaConsultaIndex) {
                        final listaConsultaConsultasRecord =
                            listaConsultaConsultasRecordList[
                                listaConsultaIndex];
                        return Container(
                          width: 100.0,
                          height: 76.0,
