...
DocumentReference? get currentUserReference =>
    loggedIn ? CadastroUsuariosRecord.collection.doc(currentUser!.uid) : null;

CadastroUsuariosRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : CadastroUsuariosRecord.getDocument(
                  CadastroUsuariosRecord.collection.doc(uid))
              .handleError((_) {}),
    )
